...
These codes were used during the INSERM workshop "Capturing chromosone conformation: toward a 3D view of genome regulation", May 9-13, 2016 in Paris at Pasteur Institut and during the last session of C3BI Training – Introduction to NGS data analysis, 28 of June 2016 (https://c3bi.pasteur.fr/training-introduction-to-ngs-data-analysis ).
